...
export default function ThreeImagesPage() {
  return (
    <article className="prose-doc">
      ...
      <p style={BODY}>
        {/* "They share no bytes with each other" was here and is not true of
            any two files. The operative claim is the one that replaced it: no
            hash matches, so hashing cannot relate them and only the declared
            provenance can. */}
        None of these is a copy. Each is a new image, new pixels, generated by a
        different model from the picture before it. No hash will ever match one
        to another, so nothing but what they declare could ever connect them.
      </p>
