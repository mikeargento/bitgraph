...
function Steps({ items }: { items: React.ReactNode[] }) {
  return (
    <ol className="mb-4">
      {items.map((item, i) => (
        <li key={i} className="flex text-[color:var(--text)] mb-2 leading-relaxed">
          <span className="text-[color:var(--dim)] mr-3 tabular-nums shrink-0">{i + 1}.</span>
          <span>{item}</span>
        </li>
      ))}
    </ol>
  ...
  return (
    <article className="prose-doc">
      ...
      <div className="code-block">
        ...
        <pre className="text-xs font-mono leading-relaxed text-[color:var(--text)] overflow-x-auto">{MCP_URL}</pre>
      </div>
      <p className="text-base text-[color:var(--dim)] mt-3 mb-10">
      ...
      <p className="text-base text-[color:var(--dim)] mb-3">
      ...
      <p className="text-[color:var(--text)] mb-4">One command, no menus.</p>
      <div className="code-block">
        <div className="code-block-header"><span>Shell</span><CopyCode /></div>
        <pre className="text-xs font-mono leading-relaxed text-[color:var(--text)] overflow-x-auto">{`claude mcp add --transport http bitgraph ${MCP_URL}`}</pre>
      </div>
      <p className="text-base text-[color:var(--dim)] mb-8">
      ...
      <div className="code-block">
        ...
        <pre className="text-xs font-mono leading-relaxed text-[color:var(--text)] overflow-x-auto">Which tools does BitGraph offer?</pre>
      </div>
      <p className="text-[color:var(--text)] mb-10">
        A
      ...
      <div className="code-block">
        <div className="code-block-header"><span>Shell</span><CopyCode /></div>
        <pre className="text-xs font-mono leading-relaxed text-[color:var(--text)] overflow-x-auto">{`claude mcp add bitgraph -- npx -y @mikeargento/bitgraph-mcp`}</pre>
      </div>
