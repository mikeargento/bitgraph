    ...
    <>
      ...
      <section id="sec-related">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">10</span> Related Work
        </h2>

        {/* 10.1 Trusted Execution and Remote Attestation */}
        <section id="sec-tee-attestation">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">10.1</span> Trusted Execution and Remote Attestation
          </h3>
        ...
        <section id="sec-provenance-systems">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">10.2</span> Content Provenance and Credential Systems
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-reference-monitors">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">10.3</span> Reference Monitors and Access Control
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-capability">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">10.4</span> Capability-Based Security
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-ifc">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">10.5</span> Information Flow Control
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-blockchain">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">10.6</span> Blockchain and Distributed Consensus
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-dtn">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">10.7</span> Delay-Tolerant Networking and Interplanetary Protocols
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-structural-distinctions">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">10.8</span> Summary of Structural Distinctions
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
          ...
          <div className="overflow-x-auto mb-4">
            <p className="text-xs text-[#4b5563] italic mb-2">
          ...
          <div className="text-xs text-[#4b5563] leading-relaxed mb-8 space-y-1">
            <p>
      ...
      <section id="sec-examples">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">11</span> Worked Examples
        </h2>
        <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-media-capture">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">11.1</span> Secure Media Capture
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-ai-pipeline">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">11.2</span> AI Output Export Pipeline
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
      ...
      <section id="sec-instantiations">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">12</span> Instantiations of the Atomic Boundary
        </h2>
        <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-enforcement-tiers">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">12.1</span> Enforcement Tier Semantics
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
      ...
      <section id="sec-admission">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">13</span> Admission of Pre-Existing Data
        </h2>
        <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-provenance-chains">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">13.1</span> Enforced Provenance Chains
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
          ...
          <div className="my-6 border border-[#e5e7eb] bg-[#f9fafb] p-5">
            <Figure6 />
            <p className="text-xs text-[#4b5563] italic text-center mt-3">
      ...
      <section id="sec-implementation">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">14</span> Implementation Considerations
        </h2>
      ...
      <section id="sec-deployment">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">15</span> Deployment and Adoption
        </h2>
        <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
      ...
      <section id="sec-applications">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">16</span> Applications
        </h2>
        <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
      ...
      <section id="sec-birth-death">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">17</span> Birth&ndash;Death Semantics
        </h2>
        <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-bd-construction">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">17.1</span> Construction
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-bd-single-successor">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">17.2</span> Single-Successor Property
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-bd-double-spend">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">17.3</span> Relationship to Double-Spend
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
        ...
        <section id="sec-bd-trust-envelope">
          <h3 className="text-lg font-semibold mt-8 mb-3">
            <span className="text-[#4b5563] mr-2">17.4</span> Trust Envelope
          </h3>
          <p className="text-sm text-[#1f2937] leading-relaxed mb-2">
      ...
      <section id="sec-value-transfer">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">18</span> Single-Transfer Value Without Consensus
        </h2>
        <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
      ...
      <section id="sec-conclusion">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">19</span> Conclusion
        </h2>
        <p className="text-sm text-[#1f2937] leading-relaxed mb-4">
