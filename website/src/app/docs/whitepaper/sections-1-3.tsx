    ...
    <>
      ...
      <section id="sec-introduction">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">1</span> Introduction
        </h2>
      ...
      <section id="sec-the-problem">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">2</span> The Problem:
        ...
        <section id="sec-concrete-example">
          <h3 className="text-lg font-semibold mt-10 mb-3">
            <span className="text-[#4b5563] mr-2">2.1</span> A Concrete
        ...
        <section id="sec-provenance-example">
          <h3 className="text-lg font-semibold mt-10 mb-3">
            <span className="text-[#4b5563] mr-2">2.2</span> A Second
        ...
        <section id="sec-ledger-example">
          <h3 className="text-lg font-semibold mt-10 mb-3">
            <span className="text-[#4b5563] mr-2">2.3</span> A Third
      ...
      <section id="sec-definitions">
        <h2 className="text-xl font-semibold mt-12 mb-4">
          <span className="text-[#4b5563] mr-2">3</span> Definitions and
          Terminology
        </h2>
