...
export default function SubjectsPage() {
  return (
    <div style={{ width: "90%", maxWidth: 800, margin: "0 auto", padding: "40px 0 80px" }}>
      ...
      {/* 40px, not 14: this is the seam between the intro and the two
          conditions. The pointer that used to occupy the seam carried this gap
          for a while and took it back with it. */}
      ...
      {/* ❄️ NOTHING GOES HERE. A diagram sat at this spot, then a link, then an
          ...
          example, and all four came out. The pattern is real and it is the one
          recorded above: this page answers whether BitGraph applies to you, and
          how it WORKS, or what proves it, is another page's question.

          The 40px that marks the seam between the intro and the two conditions
          now sits back on the paragraph above, where it was before the pointer
          took it over. */}
