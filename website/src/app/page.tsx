        ...
        {step === "results" && items.length > 0 && (
          <div style={{ animation: "slideIn 0.3s ease-out", display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              {/* The count reads as a headline, sized and weighted to match the
                  ...
                  single proof. */}
              <div style={{ fontSize: "clamp(20px, 6vw, 24px)", fontWeight: 700, letterSpacing: "-0.01em", color: "#0065A4", padding: "22px 16px", background: "#ffffff", border: "1px solid #d0d5dd", display: "flex", alignItems: "center", gap: 10 }}>
                {allDone && (
