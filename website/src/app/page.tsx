  ...
  return (
    <div style={{ background: "var(--bg)", color: "var(--c-text)", display: "flex", flexDirection: "column" }}>
      <style>{`
        ...
        .see-example-note { margin: 9px auto 0; font-size: 12.5px; line-height: 1.45; color: #6b7280; letter-spacing: -0.005em; }
        .see-example-sub { margin: 3px auto 0; font-size: 12.5px; line-height: 1.45; color: #6b7280; letter-spacing: -0.005em; }
          ...
          <div className="bitgraph-hero" style={{ animation: "slideIn 0.3s ease-out" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
              ...
              <div className="see-example">
                <button type="button" className="see-example-link" onClick={handleSeeExample}>
                  See an example <span className="arrow" aria-hidden="true">&rarr;</span>
                </button>
                <p className="see-example-note">BitGraph of an image generated by OpenAI</p>
