...
// files to the home page (where results and the ledger live) via the pending-drop
...
export function ProofDrop() {
  ...
  return (
    ...
    <div className="bitgraph-camera" style={{ marginBottom: 28 }}>
      <FileDrop multiple onFiles={onFiles} headline="Make another BitGraph" hint="Files already BitGraphed are looked up" />
    </div>
  );
}
